...
void main() {
  ...
  group('Form Validation Tests', () {
    ...
    testWidgets('should validate email format correctly', (tester) async {
      ...
      await tester.enterText(
          find.byKey(const Key('userEditorEmailFieldKey')), 'valid@email.com');
      await tester.enterText(
          find.byKey(const Key('userEditorFirstNameFieldKey')), 'John');
      await tester.enterText(
          find.byKey(const Key('userEditorLastNameFieldKey')), 'Doe');
      await tester.tap(find.byKey(const Key('registerSubmitButtonKey')));
      await tester.pump();
  ...
  group('Form Submission Tests', () {
    testWidgets('should handle successful registration', (tester) async {
      ...
      await tester.enterText(
          ...
          testUser.lastName!);
      await tester.enterText(
          find.byKey(const Key('userEditorEmailFieldKey')), testUser.email!);
      ...
      verify(mockRegisterBloc.add(const RegisterFormSubmitted(data: testUser)))
          .called(1);
