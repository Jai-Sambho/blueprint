...
class DistrictBloc extends Bloc<DistrictEvent, DistrictState> {
  ...
  FutureOr<void> _onLoad(
      DistrictLoad event, Emitter<DistrictState> emit) async {
    ...
    try {
      ...
      _log.debug(
          "END: getDistrict bloc: _onLoad success: {}", [district.toString()]);
    } catch (e) {
  ...
  FutureOr<void> _onLoadByCity(
      DistrictLoadByCity event, Emitter<DistrictState> emit) async {
    ...
    try {
      ...
      emit(DistrictLoadFailureState(message: e.toString()));
      _log.error(
          "END: getDistrict bloc: _onLoadByCity error: {}", [e.toString()]);
    }
  }
}
