...
void main() {
  ...
  group("OtpVerifyScreen form element appBar and formBuilder", () {
    ...
    testWidgets('should render initial UI elements correctly', (tester) async {
      ...
      expect(find.text("${S.current.otp_sent_to} test@example.com"),
          findsOneWidget);
  ...
  group("OtpVerifyScreen form element submit button", () {
    testWidgets('should call LoginOtpVerify event when otp code is valid',
      ...
      // THEN
      verify(mockLoginBloc.add(const VerifyOtpSubmitted(
              email: "test@example.com", otpCode: "123456")))
          .called(1);
    });
    ...
    testWidgets('should call LoginOtpVerify event when otp code is valid',
      ...
      loginStateController.add(const LoginLoadedState(
          username: "test@example.com", password: "123456"));
      await tester.pump();

      // THEN
      // home screen should be navigated
      expect(mockGoRouter.routerDelegate.currentConfiguration.uri.path,
    ...
    testWidgets('should show error message when otp code is invalid',
      ...
      loginStateController
          .add(const LoginErrorState(message: "Invalid OTP Token"));
      await tester.pump();
  ...
  group("OtpVerifyScreen form element resend button", () {
    testWidgets(
      ...
      // THEN
      verify(mockLoginBloc
              .add(const SendOtpRequested(email: "test@example.com")))
          .called(1);
    });
  });
}
