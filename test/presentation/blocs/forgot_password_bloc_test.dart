...
import 'package:blueprint/src/presentation/screen/forgot_password/bloc/forgot_password_bloc.dart';
...
void main() {
  ...
  group('ForgotPassword State Tests', () {
    ...
    test('initial state is ForgotPasswordState', () {
      expect(ForgotPasswordBloc(repository: repository).state,
    ...
    test("copyWith retains the same values if no arguments are provided", () {
      const state = ForgotPasswordState(
          status: ForgotPasswordStatus.failure, email: "test@example.com");
  ...
  group("ForgotPassword Bloc Test", () {
    ...
    blocTest<ForgotPasswordBloc, ForgotPasswordState>(
      ...
      setUp: () => when(repository.resetPassword(email))
      ...
      expect: () => [
        ...
        const ForgotPasswordState(
            status: ForgotPasswordStatus.success, email: email)
      ],
    );
