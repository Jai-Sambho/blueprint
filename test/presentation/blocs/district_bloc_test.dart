...
import 'package:blueprint/src/presentation/common_blocs/district/district.dart';
...
void main() {
  ...
  group("DistrictState", () {
    ...
    test("supports value comparisons", () {
      expect(const DistrictState(districts: districts, status: status),
    ...
    test("DistrictLoadSuccessState", () {
      expect(const DistrictLoadSuccessState(districts: districts),
          const DistrictLoadSuccessState(districts: districts));
    });

    test("DistrictLoadFailureState", () {
      expect(const DistrictLoadFailureState(message: "test"),
    ...
    test("DistrictState copyWith", () {
      ...
      expect(const DistrictState().copyWith(districts: districts),
  ...
  group("DistrictEvent", () {
    ...
    test("DistrictLoadList", () {
      expect(const DistrictLoadByCity(cityId: "test"),
  ...
  group("DistrictBloc", () {
    ...
    group("DistrictLoad", () {
      ...
      const failureState =
          DistrictLoadFailureState(message: "Exception: Error");
