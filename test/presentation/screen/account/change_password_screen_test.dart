...
import 'package:blueprint/src/presentation/common_blocs/authority/authority_bloc.dart';
...
void main() {
  ...
  group("ChangePasswordScreen Bloc Test", () {
    ...
    testWidgets("Validate loading state", (WidgetTester tester) async {
      // Given
      when(changePasswordBloc.stream).thenAnswer((_) => Stream.fromIterable(
  ...
  group("ChangePasswordScreen SubmitButtonTest", () {
    testWidgets(
        ...
        (tester) async {
      when(changePasswordBloc.add(const ChangePasswordChanged(
      ...
      final newPasswordField =
          find.byKey(changePasswordTextFieldNewPasswordKey);
    ...
    testWidgets(
        'given same password when submit button clicked then change password',
        (tester) async {
      // Given
      ...
      verify(changePasswordBloc.add(const ChangePasswordChanged(
