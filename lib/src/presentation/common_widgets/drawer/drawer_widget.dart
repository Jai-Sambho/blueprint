...
class ApplicationDrawer extends StatelessWidget {
    ...
    return BlocListener<DrawerBloc, DrawerState>(
      ...
      child: BlocBuilder<DrawerBloc, DrawerState>(
        builder: (context, state) {
          ...
          final menuNodes = state.menus
              .where((e) => e.level == 1 && e.active)
              .toList()
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (value) {
                      ...
                      context
                          .read<DrawerBloc>()
                          .add(ChangeThemeEvent(theme: newTheme));
                      if (value) {
                      ...
                      AppRouter()
                          .push(context, ApplicationRoutesConstants.home);
                    },
                  ),
                  SwitchListTile(
                    ...
                    onChanged: (value) {
                      ...
                      context
                          .read<DrawerBloc>()
                          .add(ChangeLanguageEvent(language: newLang));
                      AppRouter()
                          .push(context, ApplicationRoutesConstants.home);
                    },
                  ),
      ...
      itemBuilder: (context, index) {
        ...
        if (childMenus.isEmpty) {
          ...
          return ListTile(
            ...
            title: Text(S.of(context).translate_menu_title(node.name),
          ...
          return ExpansionTile(
            ...
            children: childMenus.map((childMenu) {
              return ListTile(
                leading:
                    Icon(String2Icon.getIconDataFromString(childMenu.icon)),
                title: Text(S.of(context).translate_menu_title(childMenu.name),
  ...
  Future<void> _handleLogout(BuildContext context) async {
    final shouldLogout = await ConfirmationDialog.show(
            context: context, type: DialogType.logout) ??
        false;
