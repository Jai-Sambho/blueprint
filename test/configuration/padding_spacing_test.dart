  ...
  group('Spacing', () {
    ...
    group('Height percentage calculations', () {
      ...
      testWidgets(
        ...
        // When & Then
        expect(() => Spacing.heightPercentage10(invalidContext!),
            throwsA(isA<TypeError>()));
        expect(() => Spacing.heightPercentage(invalidContext!, 0.5),
            throwsA(isA<TypeError>()));
      });
    });
    ...
    group('Width percentage calculations', () {
      ...
      testWidgets(
        ...
        // When & Then
        expect(() => Spacing.widthPercentage10(invalidContext!),
            throwsA(isA<TypeError>()));
        expect(() => Spacing.widthPercentage(invalidContext!, 0.5),
            throwsA(isA<TypeError>()));
      });
    });
  });
