...
class UserFormFields {
  ...
  /// return TextField
  static Widget usernameField(BuildContext context, String? initialValue,
          {bool enabled = true}) =>
  ...
  /// [enabled] bool enable the field default is true
  /// return TextField
  static Widget firstNameField(BuildContext context, String? initialValue,
          {bool enabled = true}) =>
      FormBuilderTextField(
  ...
  /// [enabled] bool enable the field default is true
  /// return TextField
  static Widget lastNameField(BuildContext context, String? initialValue,
          {bool enabled = true}) =>
      FormBuilderTextField(
  ...
  /// [enabled] bool enable the field default is true
  /// return TextField
  static Widget emailField(BuildContext context, String? initialValue,
          {bool enabled = true}) =>
      FormBuilderTextField(
  ...
  /// [enabled] bool enable the field default is true
  /// return Switch
  static Widget activatedField(BuildContext context, bool? initialValue,
          {bool enabled = true}) =>
      FormBuilderSwitch(
  ...
  static Widget authoritiesField(
          BuildContext context, List<String?>? initialValue,
          {bool enabled = true}) =>
