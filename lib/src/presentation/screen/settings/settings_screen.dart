...
import 'package:blueprint/src/presentation/screen/components/language_selection_dialog.dart';
    ...
    return FormBuilder(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
              child: SizedBox(
                  width: 150, child: _buildChangePasswordButton(context))),
          const SizedBox(height: 20),
          Center(
              child: SizedBox(
                  width: 150, child: _buildChangeLanguageButton(context))),
          const SizedBox(height: 20),
          Center(
              child: SizedBox(width: 150, child: _buildLogoutButton(context))),
        ],
      ),
    );
  }
