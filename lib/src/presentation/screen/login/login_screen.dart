import 'package:blueprint/src/configuration/app_key_constants.dart';
import 'package:blueprint/src/configuration/constants.dart';
...
import 'package:blueprint/src/utils/app_constants.dart';
...
class LoginScreen extends StatelessWidget {
  final GlobalKey<FormBuilderState> _loginFormKey =
      GlobalKey<FormBuilderState>(debugLabel: '__loginFormKey__');
  final GlobalKey<ScaffoldState> _scaffoldKey =
      GlobalKey<ScaffoldState>(debugLabel: '__loginScaffoldKey__');
  ...
  AppBar _buildAppBar(BuildContext context) =>
      AppBar(title: const Text(AppConstants.appName), leading: Container());
  ...
  Image _logo(BuildContext context) {
    if (Theme.of(context).brightness == Brightness.dark) {
      return Image.asset(LocaleConstants.logoLightUrl,
  ...
  void _submitEvent(BuildContext context,
    ...
    context
        .read<LoginBloc>()
        .add(LoginFormSubmitted(username: username, password: password));
  }
  ...
  _forgotPasswordLink(BuildContext context) {
    return SizedBox(
      child: TextButton(
        ...
        onPressed: () => AppRouter()
            .push(context, ApplicationRoutesConstants.forgotPassword),
        ...
        return ResponsiveSubmitButton(
          ...
          onPressed: () {
            if (_formKey.currentState?.saveAndValidate() ?? false) {
              ...
              context
                  .read<LoginBloc>()
                  .add(VerifyOtpSubmitted(email: email, otpCode: otpCode));
            }
          },
        );
      },
