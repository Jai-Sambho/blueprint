...
@GenerateMocks(
    [LoginBloc, AccountBloc, ForgotPasswordBloc, RegisterBloc, AppLocalStorage])
void main() {
  ...
  setUp(() {
    ...
    when(appLocalStorage.read(StorageKeys.jwtToken.name))
        .thenAnswer((_) => Future.value(null));
    when(appLocalStorage.save(StorageKeys.jwtToken.name, any))
        .thenAnswer((_) => Future.value(true));
    when(appLocalStorage.save(StorageKeys.username.name, any))
        .thenAnswer((_) => Future.value(true));
  ...
  group('LoginScreen Tests', () {
    testWidgets('Successful login scenario', (tester) async {
      ...
      // Assert
      verify(loginBloc.add(const LoginFormSubmitted(
    ...
    testWidgets('Forgot password navigation test', (tester) async {
      ...
      // Assert
      expect(goRouter.routerDelegate.currentConfiguration.uri.path,
