...
void main() {
  ...
  group("RegisterState", () {
    ...
    test("supports value comparisons", () {
      expect(const RegisterState(data: user, status: status),
    ...
    test("RegisterCompletedState", () {
      expect(const RegisterCompletedState(user: user),
          const RegisterCompletedState(user: user));
    });

    test("RegisterErrorState", () {
      expect(const RegisterErrorState(message: "Register Error"),
    ...
    test("RegisterState copyWith", () {
      ...
      expect(const RegisterState().copyWith(data: user),
          const RegisterState(data: user));
      expect(const RegisterState().copyWith(status: status),
