...
import 'package:blueprint/src/presentation/common_blocs/city/city.dart';
...
void main() {
  ...
  group("CityState", () {
    ...
    test("supports value comparisons", () {
      expect(const CityState(cities: cities, status: status),
