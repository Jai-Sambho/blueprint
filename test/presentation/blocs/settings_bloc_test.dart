...
import 'package:blueprint/src/presentation/screen/settings/bloc/settings.dart';
...
void main() {
  ...
  group("SettingsState Test", () {
    ...
    test("SettingsLanguageChanged", () {
      expect(const SettingsLanguageChanged(language: "en"),
          const SettingsLanguageChanged(language: "en"));
      expect(const SettingsLanguageChanged(language: "en").props,
          [SettingsStatus.success, "en"]);
    });
    test("SettingsThemeChanged", () {
      expect(const SettingsThemeChanged(theme: AdaptiveThemeMode.system),
  ...
  group("SettingsEvent Test", () {
    ...
    test("ChangeLanguage", () {
      expect(const ChangeLanguage(language: "en"),
          const ChangeLanguage(language: "en"));
      expect(const ChangeLanguage(language: "en").props, ["en"]);
    });
    test("ChangeTheme", () {
      expect(const ChangeTheme(theme: AdaptiveThemeMode.system),
