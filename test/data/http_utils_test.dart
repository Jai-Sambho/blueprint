...
import 'package:blueprint/src/data/http_utils.dart';
...
void main() {
  ...
  group('HttpUtils Tests', () {
    ...
    test('given a new custom header when added then it should be in headers',
        () async {
    ...
    group('HTTP Requests', () {
      ...
      test(
        ...
        expect(HttpUtils.postRequest('/test', {'data': 'test'}),
      ...
      test(
        ...
        await expectLater(
            HttpUtils.getRequest('/test'), throwsA(isA<FetchDataException>()));
      ...
      test(
        ...
        await expectLater(HttpUtils.getRequest('/test'),
      ...
      test(
        ...
        await expectLater(HttpUtils.putRequest('/test', {'data': 'test'}),
            throwsA(isA<FetchDataException>()));
      ...
      group('PATCH', () {
        test(
          ...
          final response =
              await HttpUtils.patchRequest('/test', {'data': 'test'});
          expect(response.statusCode, lessThan(300));
        });
        ...
        test(
          ...
          await expectLater(HttpUtils.patchRequest('/test', {'data': 'test'}),
              throwsA(isA<FetchDataException>()));
      ...
      test(
        ...
        expect(HttpUtils.deleteRequest('/test'),
            throwsA(isA<FetchDataException>()));
        await expectLater(
            HttpUtils.deleteRequest('/test'),
            throwsA(allOf([
      ...
      group('Mock Requests', () {
        ...
        test(
          ...
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.dev);
          expect(() => HttpUtils.mockRequest('GET', '/test'),
              throwsA(isA<UnauthorizedException>()));
          await expectLater(
        ...
        test(
          ...
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.dev);
          expect(() => HttpUtils.mockRequest('POST', '/test'),
              throwsA(isA<UnauthorizedException>()));
          await expectLater(
        ...
        test(
          ...
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.dev);
          expect(() => HttpUtils.mockRequest('PUT', '/test'),
              throwsA(isA<UnauthorizedException>()));
          await expectLater(
        ...
        test(
          ...
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.dev);
          expect(() => HttpUtils.mockRequest('DELETE', '/test'),
              throwsA(isA<UnauthorizedException>()));
          await expectLater(
