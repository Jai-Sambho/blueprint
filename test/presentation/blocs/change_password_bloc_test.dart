...
import 'package:blueprint/src/presentation/screen/change_password/bloc/change_password_bloc.dart';
...
void main() {
  ...
  group("ChangePasswordBloc", () {
    test("initial state is LoginState", () {
      expect(ChangePasswordBloc(repository: repository).state,
          const ChangePasswordState(status: ChangePasswordStatus.initial));
    });
    ...
    group("ChangePasswordChanged", () {
      ...
      const errorState =
          ChangePasswordState(status: ChangePasswordStatus.failure);
