...
import 'package:blueprint/src/presentation/screen/user/editor/user_editor_screen.dart';
import 'package:blueprint/src/presentation/screen/user/list/list_user_screen.dart';
...
class UserRoutes {
  ...
  static final List<GoRoute> routes = <GoRoute>[
    ...
    GoRoute(
      ...
      builder: (BuildContext context, GoRouterState state) => _blocProvider(
          UserEditorScreen(
              id: state.pathParameters['id']!, mode: EditorFormMode.edit)),
    ),
    GoRoute(
      name: 'userView',
      path: '/user/:id/view',
      builder: (BuildContext context, GoRouterState state) => _blocProvider(
          UserEditorScreen(
              id: state.pathParameters['id']!, mode: EditorFormMode.view)),
    ),
  ];
}
